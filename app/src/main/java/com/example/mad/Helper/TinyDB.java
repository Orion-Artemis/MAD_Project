...
public class TinyDB {
    ...
    public ArrayList<ChangeDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ChangeDomain> playerList =  new ArrayList<ChangeDomain>();

        for(String jObjString : objStrings){
            ChangeDomain player  = gson.fromJson(jObjString,  ChangeDomain.class);
    ...
    public void putListObject(String key, ArrayList<ChangeDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ChangeDomain player: playerList){
